...
public class Runner {
    public static void main(String[] args) {
        ...
        System.out.println(adm1.changePassword("1234","1234"));
        System.out.println(adm1.changePassword("123456789010","123456789010"));

        System.out.println(adm1.changePassword("1234","1234",customer2));

        System.out.println(customer1.changePassword("1234","1234"));
    }
}
